...
- Q11-12：决定 SLO 告警阈值策略；当前倾向是在没有连续生产 Prometheus 历史前暂缓 paging-grade alerting，并记录明确 deferred decision。
