...
开发计划和单模块交付规则已记录在 [`docs/product-navigation-roadmap-2026-08-24.md`](docs/product-navigation-roadmap-2026-08-24.md)，本节只维护阶段状态；导航已按参考方案固定为五组，N0 导航壳、N1 工作台与任务中心、N2.1/N2.2/N2.3/N2.4/N2.5、N3.1 API、N3.2 APP、N3.3 UI、N3.4 性能、N4.1 AI 智能测试工作台、N4.2 Hermes 助手、N4.3 需求与用例追踪和 N4.4 知识中枢本地实现、审查和回归已完成，均待真实环境验收。
...
当前推荐下一步：进入 N5 远程工具箱与配置中心，统一检查 Worker、Redis、MinIO、PostgreSQL、ADB、浏览器节点和性能节点，并补齐配置差异、变更审计和可控回滚；N4.1/N4.2/N4.3/N4.4 及 N3.1 API、N3.2 APP、N3.3 UI、N3.4 性能和 N1/N2.1/N2.2/N2.3/N2.4/N2.5 的真实环境验收作为并行环境证据补齐。每个模块完成后先审查和修复，再同步文档并提交推送。
