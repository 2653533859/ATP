...
> 当前有效顺序（2026-08-25 2.2.0）：导航已统一为“工作台、测试能力、测试资产、智能中枢、系统”五组；N2 Karing 单设备闭环已通过，当前执行游标转为 P0/N4 真实性能环境。N4 因缺少 Kubernetes、发布级 Prometheus 指标覆盖和独立 MinIO 保持阻塞；q19 Compose Prometheus 仅作为观察，随后按 P1/N5、P2/N6、P3/N7、P4/N8 和 P5/N9 推进。详细阶段、验收出口和状态口径以开发计划 2.2.0 为准，下方更早的 2.1.0 及历史记录不覆盖当前执行版。
