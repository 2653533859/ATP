...
开发计划和单模块交付规则已记录在 [`docs/product-navigation-roadmap-2026-08-24.md`](docs/product-navigation-roadmap-2026-08-24.md)，本节只维护阶段状态；导航已按参考方案固定为五组，N0 导航壳、N1 工作台与任务中心、N2.1/N2.2/N2.3/N2.4/N2.5、N3.1 API、N3.2 APP、N3.3 UI、N3.4 性能、N4.1 AI 智能测试工作台、N4.2 Hermes 助手、N4.3 需求与用例追踪、N4.4 知识中枢、N5.1 远程工具箱和 N5.2.1～N5.2.6 配置中心本地实现、审查和回归已完成，均待真实环境验收；N6.3 已补充 Windows API/Web 最小 readiness 证据，不能替代完整发布验收。
...
- [~] N6 质量收口：回归、E2E、迁移、文档、外部环境证据和发布检查；N6.1/N6.2 已完成本地回归与文档收口，N6.3 已完成 Windows API/Web 最小 readiness 和远端 Redis/验收栈恢复，完整登录、Worker、真机、性能、通知和外部平台证据仍待补齐。

当前推荐下一步：补做完整 Windows 登录/Web/报告验收，再按优先级完成 Android Worker/真机、真实性能节点、通知渠道和外部缺陷平台证据。N5.2 已统一聚合启动配置、环境、全局变量、AI、存储、通知和性能配置，N6.1/N6.2/N6.3 已完成本地回归、文档和部分环境证据；每个子模块完成后先审查和修复，再同步文档并提交推送。
