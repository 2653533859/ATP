...
- [~] C3 迁移、备份恢复、SLO、证据索引和最终 SHA 发布收口：C3.1～C3.3 与 C3.4.1 已完成。C3.4.2 已取得 2026-09-13～19 连续 7 个完整 UTC 日的 Backend/Worker `288/288` 抓取，但只有 9 月 14 日存在 34 次有界合成请求和 3 次运行，其余 6 日没有业务样本；初始校准因此为未通过，告警和发布门禁继续 deferred。采集器进一步修复 Prometheus 午夜 range 样本被归入次日造成“运行量 0、成功率 100%”的跨日污染，定向 `20 passed`、非集成后端全量 `2618 passed / 1 skipped`。仍须重新积累有代表性流量的连续 7/14 天；候选异机 `172.31.27.133` 尚不可用于独立 MinIO，之后才能进入 C3.5 最终 SHA/证据索引。证据见 [`docs/slo-history-2026-09-13-2026-09-19.md`](docs/slo-history-2026-09-13-2026-09-19.md) 与 [`docs/evidence/c3-slo-history-day7-2026-09-20.json`](docs/evidence/c3-slo-history-day7-2026-09-20.json)。
