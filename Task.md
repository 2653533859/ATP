...
- [~] C3 迁移、备份恢复、SLO、证据索引和最终 SHA 发布收口：C3.1～C3.3 与 C3.4.1 已完成。C3.4.2 已增加可独立运行的 SLO-only 采集、每天 288 个五分钟连续性检查点、`NaN`/无穷值过滤及缺口门禁；真实首日 preflight 为 Backend/Worker 各 17/288，SLO 无完整样本，告警与发布门禁按预期保持 deferred。候选异机 `172.31.27.133:22` 从 Windows 和发布主机均超时，未部署 MinIO。继续等待 7/14 天历史与可达的不同故障域 MinIO，之后进入 C3.5 最终 SHA/证据索引。证据见 [`docs/evidence/c3-slo-history-preflight-2026-09-13.json`](docs/evidence/c3-slo-history-preflight-2026-09-13.json)。
