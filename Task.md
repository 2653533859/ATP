...
- [~] Q18-验收：本地后端非集成 1721 项、前端全量 37 文件/146 测试、Playwright E2E 9 项、迁移、mypy 120 源文件、Ruff、Bandit、pip-audit、npm audit、类型检查/构建和文档已通过；真实设备、真实性能节点、外部服务和真实 API 联调仍待环境验收。
