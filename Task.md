...
- [~] C3 迁移、备份恢复、SLO、证据索引和最终 SHA 发布收口：C3.1～C3.3 与 C3.4.1 已完成。首个 7 日窗口因 6 日无业务样本未通过；9 月 20 日因主机重启只有 276/288 抓取点而被拒绝。9 月 21/22 日完整 UTC 日的 Backend/Worker 均为 288/288，可用性 100%、P95 95ms、运行成功率 100%，但每天只有 21/20 次请求和 2 次运行，均为有界合成 canary；9 月 21 日首次定时任务失败后人工重试，9 月 22 日无人值守成功。发布 Grafana 已通过同源 Prometheus 数据查询与 17 面板核对；7/14 日代表性流量校准与独立 MinIO 仍待完成，告警和发布门禁保持 deferred；自动采集不再仅凭 14 天无超标启用门禁，Q12 验收摘要须经人工审查。证据见 [9 月 21 日](docs/slo-history-2026-09-21-2026-09-21.md)、[9 月 22 日](docs/slo-history-2026-09-22-2026-09-22.md)及 [Grafana 验证](docs/evidence/c3-slo-grafana-2026-09-23.json)。
