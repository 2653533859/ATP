...
开发计划和单模块交付规则已记录在 [`docs/product-navigation-roadmap-2026-08-24.md`](docs/product-navigation-roadmap-2026-08-24.md)，本节只维护阶段状态；导航已按参考方案固定为五组，N0 导航壳、N1 工作台与任务中心、N2.1/N2.2/N2.3/N2.4/N2.5、N3.1 API、N3.2 APP、N3.3 UI、N3.4 性能、N4.1 AI 智能测试工作台和 N4.2 Hermes 助手本地实现和审查已完成，均待真实环境验收。
...
- [~] N4 智能中枢：N4.1 AI 智能测试工作台和 N4.2 Hermes 助手已完成；需求与用例追踪、知识中枢仍待实现。
...
当前推荐下一步：进入 N4.3 需求与用例追踪，复用现有 AI 用例生成和用例评审链路建立需求解析、验收标准和需求—用例关联；N4.1/N4.2 及 N3.1 API、N3.2 APP、N3.3 UI、N3.4 性能和 N1/N2.1/N2.2/N2.3/N2.4/N2.5 的真实环境验收作为并行环境证据补齐。每个模块完成后先审查和修复，再同步文档并提交推送。
