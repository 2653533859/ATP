...
- [~] C3 迁移、备份恢复、SLO、证据索引和最终 SHA 发布收口：C3.1～C3.3 与 C3.4.1 已完成。C3.4.2 的 2026-09-13～19 首个 7 日窗口因 6 日无业务样本未通过；9 月 20 日虽有 30 次请求、95ms P95 和 2/2 passed 运行，但主机重启造成 Backend/Worker 各 `276/288`，不能作为新窗口首日。现已创建独立 `tester` canary 身份并授予项目 77 `editor`，使用 systemd `LoadCredential` 与每日 08:30（Asia/Shanghai）持久 timer 产生 12 次认证读取和 2 次安全自回环运行；首次正式验证 Run 117/118 passed、HTTP/P95/`case/passed` 指标增长且报告不含凭据。新连续窗口从 2026-09-21 起重新计数，须在 UTC 日结束后确认完整性并持续至 7/14 天；候选异机 `172.31.27.133` 尚不可用于独立 MinIO，之后才能进入 C3.5。证据见 [`docs/slo-history-2026-09-20-2026-09-20.md`](docs/slo-history-2026-09-20-2026-09-20.md) 与 [`docs/evidence/c3-slo-daily-canary-2026-09-21.json`](docs/evidence/c3-slo-daily-canary-2026-09-21.json)。
