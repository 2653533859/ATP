...
- Release Prometheus history: collection started on 2026-09-13 for the current single-node target. The standalone collector retains 15 days and currently scrapes Backend, ordinary Worker, Performance Worker and itself. Both 2026-09-13 and 2026-09-14 have 288/288 Backend and Worker checkpoints. The first day has no business samples; the second has 34 bounded synthetic requests and 3 runs, with 100% availability, 95ms P95 and 100% run success. Ratio queries exclude hours without matching business activity, and each SLO receives an independent decision; see [`slo-history-2026-09-13-2026-09-13.md`](slo-history-2026-09-13-2026-09-13.md) and [`slo-history-2026-09-14-2026-09-14.md`](slo-history-2026-09-14-2026-09-14.md). The collector rejects the current or a future UTC day rather than recording a partial day as history.
