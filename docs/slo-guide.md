...
- 2026-09-23 also has a complete UTC-day preflight: Backend/Worker 288/288, 20 requests, two runs, 100% availability and run success, P95 95ms, with no breach or gap. The traffic is still bounded synthetic canary traffic, so alert and release gates remain deferred. The 2026-09-24 unattended canary succeeded with 12 authenticated reads and two passed runs; that UTC day is not complete yet. See [`slo-history-2026-09-23-2026-09-23.md`](slo-history-2026-09-23-2026-09-23.md).
...
- The 2026-09-24～25 complete UTC-day preflight has a Backend `up=0` point on the 24th and only low-volume controlled traffic on the 25th; release gates remain deferred. The first labeled Worker run-outcome series appeared at value 1 during the September 25 canary, so Prometheus omitted that first run from its daily `increase` estimate. The repository now initializes outcome series at zero, but the release Worker has not yet been upgraded; the historic count remains uncorrected. See [`slo-history-2026-09-24-2026-09-25.md`](slo-history-2026-09-24-2026-09-25.md) and [`evidence/c3-slo-flower-checkpoint-2026-09-27.md`](evidence/c3-slo-flower-checkpoint-2026-09-27.md).
