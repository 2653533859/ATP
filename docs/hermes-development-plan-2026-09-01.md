...
> 版本：H8 / 2026-09-04
> 状态：H1～H8 本地实现完成，真实模型阈值、成本 usage、目标部署和生产角色矩阵待复核
> 关联计划：[`development-plan-2026-08-25.md`](development-plan-2026-08-25.md) 2.4.31
...
推荐顺序：H2 → H3 → H4 → H5 → H6 → H7 → H8。H3 的自动选择与编排在固定工具契约、项目隔离和会话上下文完成后推进；H6～H8 不开放写工具。
