...
- Backend upgrades: `fastapi==0.139.0`, `starlette==1.3.1`, `python-jose[cryptography]==3.5.0`, `python-multipart==0.0.32`, `pytest==9.0.3`, `pytest-asyncio==1.3.0`, `jinja2==3.1.6`, `cryptography==48.0.1`, `prometheus-fastapi-instrumentator==8.0.2`.
