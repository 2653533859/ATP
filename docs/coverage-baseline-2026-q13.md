...
| After Q14-00 evidence tooling | 1317 passed | 82.20% | 70% | Added publishable Q12 external-evidence templates, a scaffold helper, structural validator coverage, and `make scaffold-q12-evidence` / `make validate-q12-evidence` so the remaining environment-blocked SLO/device captures have a repeatable acceptance gate. |
