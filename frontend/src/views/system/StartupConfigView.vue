...
interface StartupConfig {
  ...
  WEB_EXECUTION_QUEUE: string
  PROTOCOL_EXECUTION_QUEUE: string
...
const defaultConfig: StartupConfig = {
  ...
  CELERY_CONCURRENCY: 4, CELERY_QUEUES: 'default,android,mobile_special,ios,ai,maintenance,performance', WEB_EXECUTION_QUEUE: 'default', PROTOCOL_EXECUTION_QUEUE: 'default', SUITE_CHILD_TASK_TIMEOUT_SECONDS: 3600, WORKER_METRICS_PORT: 9091,
...
const sections: ConfigSection[] = [
  ...
  },
  {
    ...
    fields: [
      number('CELERY_CONCURRENCY'), textarea('CELERY_QUEUES'), text('WEB_EXECUTION_QUEUE'), text('PROTOCOL_EXECUTION_QUEUE'), number('SUITE_CHILD_TASK_TIMEOUT_SECONDS'), number('WORKER_METRICS_PORT', { max: 65535 }), number('FILE_RETENTION_DAYS'),
