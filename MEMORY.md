...
- Next Q11 action: start Q11-12 and decide whether to add Grafana alert templates for calibrated SLOs now or explicitly defer paging-grade alerting until production Prometheus history exists.
